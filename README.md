...
![System Architecture](docs/e_train_tickets.png)
...
##  Summary
This platform behaves like a real-time national transportation reservation engine:
✔ Secure identity-based booking
✔ Accurate seat inventory control
✔ Strong authentication and RBAC authorization
✔ Reliable payment and refund workflows
✔ Highly scalable and production-ready architecture
